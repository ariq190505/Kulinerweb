...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    echo "<script>alert('Invalid ID');window.location='?page=makanan';</script>";
    exit;
}
...
if (!$result || mysqli_num_rows($result) == 0) {
    echo "<script>alert('Data not found');window.location='?page=makanan';</script>";
    exit;
}
        ...
        <div class="form-card">
            <form method="post" action="?page=makananUpdateProses">
                ...
                <div class="button-group">
                    <button type="button" class="btn btn-secondary" onClick="document.location='?page=makanan'">Batal</button>
